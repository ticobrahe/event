  ...
  <div class="auto-container">
    <div class="row clearfix">
      <div class="col-md-10 col-md-offset-1 col-sm-12 contact-form">
        ...
        <div class="jumbotron">
          <div class="container">
            <form  method="post" action="/privatesecurity-form'" >
              {{csrf_field()}} 
              ...
              <div class="field-container clearfix">  
                <div class="form-group" >
                    ...
                    <div class="controls col-md-7 ">
                        <input class=" form-control" name="contact_phone" value="{{old('contact_phone')}}"style="margin-bottom: 13px" type="number"/>
                    </div>
                </div>
              </div>
               <div class="field-container clearfix">  
                  <div class="form-group" >
                      <label class="control-label col-md-3">Description<span style="color: red"><strong>*</strong></span></label>
                      <div class="controls col-md-7 ">
